...
<details><summary><b>[8] Nemoy-Regular.ttf</b></summary><div><details><summary>💔 <b>ERROR:</b> Familyname must be unique according to namecheck.fontdata.com (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/fontdata_namecheck">com.google.fonts/check/fontdata_namecheck</a>)</summary><div>
 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: old-permic, math, tai-le, canadian-aboriginal, syriac, coptic, tifinagh, malayalam
 ...
 * U+25CC DOTTED CIRCLE: try adding one of: miao, symbols, psalter-pahlavi, devanagari, old-permic, hanunoo, kayah-li, sharada, buhid, masaram-gondi, phags-pa, lepcha, grantha, hanifi-rohingya, hebrew, cham, buginese, caucasian-albanian, batak, gurmukhi, khmer, mende-kikakui, sinhala, soyombo, new-tai-lue, mahajani, tai-le, modi, gunjala-gondi, wancho, takri, sogdian, kannada, khudawadi, gujarati, coptic, zanabazar-square, duployan, music, sundanese, myanmar, thai, syriac, telugu, tibetan, tagalog, syloti-nagri, dogra, adlam, ahom, thaana, brahmi, bhaiksuki, newa, khojki, tamil, elbasan, manichaean, bassa-vah, tirhuta, osage, siddham, kharoshthi, mandaic, balinese, kaithi, tifinagh, malayalam, bengali, limbu, chakma, marchen, lao, javanese, meetei-mayek, nko, rejang, yi, pahawh-hmong, oriya, tai-viet, math, tagbanwa, mongolian
...
</div></details><br></div></details><details><summary><b>[8] Nemoy-Black.ttf</b></summary><div><details><summary>💔 <b>ERROR:</b> Familyname must be unique according to namecheck.fontdata.com (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/fontdata_namecheck">com.google.fonts/check/fontdata_namecheck</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[9] Nemoy-Medium.ttf</b></summary><div><details><summary>💔 <b>ERROR:</b> Familyname must be unique according to namecheck.fontdata.com (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/fontdata_namecheck">com.google.fonts/check/fontdata_namecheck</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[8] Nemoy-Light.ttf</b></summary><div><details><summary>💔 <b>ERROR:</b> Familyname must be unique according to namecheck.fontdata.com (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/fontdata_namecheck">com.google.fonts/check/fontdata_namecheck</a>)</summary><div>
...
</div></details><br></div></details><details><summary><b>[9] Nemoy-Bold.ttf</b></summary><div><details><summary>💔 <b>ERROR:</b> Familyname must be unique according to namecheck.fontdata.com (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/fontdata_namecheck">com.google.fonts/check/fontdata_namecheck</a>)</summary><div>
